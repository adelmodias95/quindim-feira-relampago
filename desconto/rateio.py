...
itens = [
    {"preco_centavos": 3990, "quantidade": 1, "sku": "QND-001"},
    {"preco_centavos": 2990, "quantidade": 1, "sku": "QND-002"},
    {"preco_centavos": 1995, "quantidade": 1, "sku": "QND-003"},
]

print(calcular_valores(itens))
